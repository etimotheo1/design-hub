...
const MAP: Record<ColorToken, ColorClasses> = {
  emerald: {
    ...
    cardSelected:  "border-emerald-500 ring-4 ring-emerald-100",
    cardSelectedDot: "bg-emerald-500",
  ...
  sky: {
    ...
    cardSelected: "border-sky-500 ring-4 ring-sky-100",
  ...
  amber: {
    ...
    cardSelected: "border-amber-500 ring-4 ring-amber-100",
  ...
  indigo: {
    ...
    cardSelected: "border-indigo-500 ring-4 ring-indigo-100",
  ...
  pink: {
    ...
    cardSelected: "border-pink-500 ring-4 ring-pink-100",
  ...
  violet: {
    ...
    cardSelected: "border-violet-500 ring-4 ring-violet-100",
  ...
  rose: {
    ...
    cardSelected: "border-rose-500 ring-4 ring-rose-100",
  ...
  cyan: {
    ...
    cardSelected: "border-cyan-500 ring-4 ring-cyan-100",
  ...
  slate: {
    ...
    cardSelected: "border-slate-500 ring-4 ring-slate-100",
  ...
  blue: {
    ...
    cardSelected: "border-blue-500 ring-4 ring-blue-100",
  ...
  red: {
    ...
    cardSelected: "border-red-500 ring-4 ring-red-100",
  ...
  teal: {
    ...
    cardSelected: "border-teal-500 ring-4 ring-teal-100",
